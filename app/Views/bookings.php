...
<div class="stat-box px-3 px-md-4 py-3 py-lg-4 shadow-sm rounded">
	<div class="col-12 text-right px-0 mb-3">
		<?php if (session()->get('logged_in.role') == "admin"): ?>
			<b-button variant="outline-success" @click="clearBookings" title="Reset bookings" class="mr-2">
				<b-icon icon="bootstrap-reboot"></b-icon>
					Bookings
			</b-button>
		<?php endif ?>
		<b-button variant="outline-primary" @click="fetchBookingsList" title="Fetch bookings">
