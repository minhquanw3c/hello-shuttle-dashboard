...
var app = new Vue({
    ...
    createCar: function () {
      ...
      const payload = {
        form: {
          ...
          firstMilesPriceActive: modalData.priceConfig.firstMilesPriceActive,
          //---
          secondMiles: modalData.priceConfig.secondMiles,
          secondMilesPrice: modalData.priceConfig.secondMilesPrice,
          secondMilesPriceActive: modalData.priceConfig.secondMilesPriceActive,
          //---
          thirdMiles: modalData.priceConfig.thirdMiles,
          thirdMilesPrice: modalData.priceConfig.thirdMilesPrice,
          thirdMilesPriceActive: modalData.priceConfig.thirdMilesPriceActive,
          //---
          adminFeeLimitMiles: modalData.priceConfig.adminFee.limitMiles,
          adminFeeType: modalData.priceConfig.adminFee.type,
          adminFeePercentage: modalData.priceConfig.adminFee.percentage,
          adminFeeFixedAmount: modalData.priceConfig.adminFee.fixedAmount,
          adminFeeActive: modalData.priceConfig.adminFee.active,
          //---
          pickUpFeeLimitMiles: modalData.priceConfig.pickupFee.limitMiles,
          pickUpFeeType: modalData.priceConfig.pickupFee.type,
          pickUpFeePercentage: modalData.priceConfig.pickupFee.percentage,
          pickUpFeeFixedAmount: modalData.priceConfig.pickupFee.fixedAmount,
          pickUpFeeActive: modalData.priceConfig.pickupFee.active,
          //---
          maxLuggages: modalData.priceConfig.luggage.maxCapacity,
          freeLuggagesQuantity: modalData.priceConfig.luggage.freeQuantity,
          extraLuggagesPrice: modalData.priceConfig.luggage.extrasPrice,
          //---
          maxPassengers: modalData.priceConfig.passenger.maxCapacity,
          freePassengersQuantity: modalData.priceConfig.passenger.freeQuantity,
          extraPassengersPrice: modalData.priceConfig.passenger.extrasPrice,
        },
      };
  ...
  computed: {
    ...
    errorMessage_secondMiles: function () {
      ...
      if (
        !(self.$v.modals.editCar.secondMiles.mustGreaterThanFirstMiles === true)
      ) {
  ...
  validations: {
    modals: {
      ...
      editCar: {
        ...
        pickUpFeePercentage: {
          requiredIf: requiredIf(function () {
            return this.$v.modals.editCar.pickUpFeeType.$model === "percentage";
          }),
        },
        pickUpFeeFixedAmount: {
          requiredIf: requiredIf(function () {
            return this.$v.modals.editCar.pickUpFeeType.$model === "fixed";
          }),
        },
        // Luggages
        maxLuggages: {
        ...
        priceConfig: {
          ...
          adminFee: {
            ...
            percentage: {
              requiredIf: requiredIf(function () {
                return (
                  this.$v.modals.createCar.priceConfig.adminFee.type.$model ===
                  "percentage"
                );
              }),
            },
          ...
          pickupFee: {
            ...
            percentage: {
              requiredIf: requiredIf(function () {
                return (
                  this.$v.modals.createCar.priceConfig.pickupFee.type.$model ===
                  "percentage"
                );
              }),
            },
